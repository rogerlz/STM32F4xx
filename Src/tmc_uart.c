...
#if defined(BOARD_FYSETC_S6) || defined(BOARD_BTT_SKR_PRO_1_1) || defined(BOARD_BTT_SKR_PRO_1_2) || defined(BOARD_BTT_OCTOPUS_PRO_F429) || defined(BOARD_MKS_ROBIN_NANO_30) || defined(BOARD_MKS_EAGLE)
